...
<script>
  ...
  ga('send', 'pageview');
    ...
    <img src="../Content/site/01.jpg" />
    <img src="../Content/site/02.jpg" />
	<img src="../Content/site/03.jpg" />
                </div>
                
<p>
    A WALLE esta localizada no SCS Quadra 06 ed. Carioca sala 504 (de frente com patio brasil e ao lado correio), Brasília - DF  (Veja nas imagens acima)<BR>
</p>
<p>&nbsp;</p>
<h1>Fichas de Cadastro</h1>
<h3>Word</h3>
<p class="p">
    <a href="../Files/cadastro-pessoafisica.doc">Cadastro de Pessoa Física </a>
</p>
<p class="p">
    <a href="../Files/cadastro-pessoajuridica.doc">Cadastro de Pessoa Jurídica </a>
</p>

<h3>PDF</h3>
<p class="p">
    <a href="../Files/PESSOA-FISICA.pdf">Cadastro de Pessoa Física </a>
</p>
<p class="p">
    <a href="../Files/EMPRESA-JUR.pdf">Cadastro de Pessoa Jurídica </a>
</p>

<img src="../cadastro.png" id="img_cadastro">
